...
app.post('/addContact', function (req, res) {
  ...
  console.log('unite id: ', payload.unite_id, 'employer',payload.employer, 'occupation', payload.position, 'position', payload.position, 'phone', payload.phone,'mobile:', payload.mobile )
